...
config.General.requestName = 'ParkingBPH1B_AOD_DATA_UL'
...
#config.Data.unitsPerJob = 20 #running 20 files per job
...
config.Data.outputDatasetTag = 'ParkingBPH1B_AOD_DATA_UL' # Naming for CRAB and maps
